...
def play_guitar_sound_with_tone(volume, tone_frequency, tone_duration):
    ...
    for i in range(5):
        ...
        strong_sound.play()
        wait_for_response_or_timeout(1.0, tone_start_time, strong_sound, weak_sound, tone_sound)
...
# Function to wait for a response or timeout
def wait_for_response_or_timeout(timeout, tone_start_time, strong_sound, weak_sound, tone_sound):
